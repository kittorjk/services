    ...
    <div class="panel panel-info" >
      <div class="panel-heading" align="center">
        <div class="panel-title">
          {{ $pendientes->count() == 1 ? '1 rendición pendiente' : 'Rendiciones pendientes' }}
        </div>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <label for="{{ $i }}" style="font-weight: normal">
                        <a href="/rendicion_viatico/{{ $pendiente->id }}">{{ $pendiente->codigo }}</a>
                    </label>
                  </td>
                  <td>{{ date_format($pendiente->created_at,'d-m-Y') }}</td>
                  ...
                  <td align="center">
                    @if($user->id === $pendiente->usuario_creacion || $user->priv_level == 4)
                      ...
                      &ensp;
                      <a href="{{ '/rendicion_viatico/estado?mode=cancelar&id='.$pendiente->id }}"
