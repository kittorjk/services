        ...
        <div class="panel panel-sky">
            <div class="panel-heading" align="center">
                <div class="panel-title">
                    {{ 'Generar reporte de gastos por proyecto' }}
                </div>
            </div>
            <div class="panel-body">
                ...
                <form novalidate="novalidate" action="{{ '/project/expense_report/'.$type }}" method="post"
                                        ...
                                        <select id="id" name="id" class="form-control">
                                            ...
                                            @foreach($projects as $project)
                                                <option value="{{ $project->id }}" title="{{ $project->name }}"
                                                        {{ old('id')==$project->id ? 'selected="selected"' : '' }}>
                                                    {{ str_limit($project->name,150) }}
                                                </option>
                                            @endforeach
                                        </select>
                                        ...
                                        <select id="type" name="type" class="form-control">
                                            ...
                                            @foreach($areas as $area)
                                                <option value="{{ $area->type }}"
                                                        {{ old('type')==$area->type ? 'selected="selected"' : '' }}>
                                                    {{ $area->type }}</option>
                                            @endforeach
                                        </select>
