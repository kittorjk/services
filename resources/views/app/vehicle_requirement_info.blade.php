...
@section('menu_options')
    <div class="btn-group">
        ...
        <ul class="dropdown-menu dropdown-menu-prim">
            <li>
                <a href="{{ '/vehicle_requirement' }}"><i class="fa fa-refresh"></i> Ver requerimientos</a>
            </li>
    ...
    <div id="loginbox" class="mg-tp-px-50 col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2 mg-btm-px-40">
        ...
        <div class="panel panel-violet">
            <div class="panel-heading" align="center">
                <div class="panel-title">Información de requerimiento de vehículo</div>
            </div>
            <div class="panel-body">
                <div class="col-sm-12 mg20">
                    ...
                    <a href="{{ '/vehicle_requirement' }}" class="btn btn-warning" title="Ir a la tabla de requerimientos de vehículo">
                ...
                <div class="col-sm-12 mg10 mg-tp-px-10">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tr>
                            <th>Tipo</th>
                            <td colspan="3">{{ App\VehicleRequirement::$types[$requirement->type] }}</td>
                        </tr>
                        <tr>
                            <th>Fecha</th>
                        ...
                        @if($requirement->vehicle)
                            <tr>
                                ...
                                <td colspan="3">{{ $requirement->vehicle->type.' '.$requirement->vehicle->model }}</td>
                            </tr>
                            <tr>
                                <th>Placa</th>
                                <td colspan="3">{{ $requirement->vehicle->license_plate }}</td>
                            </tr>
                            <tr>
                                <th>Resp. actual</th>
                            ...
                            <tr>
                                <th>Sucursal a cargo</th>
                                <td colspan="3">{{ $requirement->branch_origin ?: $requirement->vehicle->branch }}</td>
                            </tr>
                            ...
                            @else
                                <tr>
                                    <th>Enviar a</th>
                                    <td colspan="3">{{ $requirement->branch_destination.' (Garaje)' }}</td>
                                </tr>
                            @endif
                            <tr><td colspan="4"></td></tr>
                        @endif
                ...
                @if($user->priv_level==4)
                    <div class="col-sm-12 mg10" align="center">
                        <a href="/vehicle_requirement/{{ $requirement->id }}/edit" class="btn btn-success">
