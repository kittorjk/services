      ...
      <div class="panel-body">
        <div class="col-lg-5 mg20">
          ...
          <a href="{{ '/invoice' }}" class="btn btn-warning" title="Ir a la tabla de facturas de proveedor">
            <i class="fa fa-arrow-up"></i> Facturas
          </a>
        </div>
          ...
          <table class="table table-striped table-hover table-bordered">
            <tbody>
              ...
              <tr>
                ...
                <td colspan="3">
                  {{ $invoice->concept == 'Adelanto' ? 'Pago por adelanto' : '' }}
              ...
              @if ($invoice->files->count() > 0 || $invoice->status != 'Pagado')
        ...
        {{-- @if ((($user->id == $invoice->user_id || $user->action->oc_inv_edt) && 
            substr($invoice->flags,0,2) == '00') || $user->priv_level == 4) --}}
        @if ((($user->id == $invoice->user_id || $user->action->oc_inv_edt) && 
            $invoice->status != 'Pagado') || $user->priv_level == 4)
