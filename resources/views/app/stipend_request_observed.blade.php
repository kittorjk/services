        ...
        <div class="panel panel-sky">
            <div class="panel-heading" align="center">
                <div class="panel-title">
                    {{ $stipend_requests->count()==1 ? '1 solicitud observada' :
                        $stipend_requests->count().' solicitudes observadas' }}
                </div>
            </div>
                        ...
                        @if($stipend_requests->count()==0)
                            <tr>
                                <td colspan="7" align="center">
                                    No existen solicitudes observadas
                                </td>
                            </tr>
                        @endif
                        </tbody>
