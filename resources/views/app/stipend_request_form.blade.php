    ...
    <div class="panel panel-sky">
      ...
      <div class="panel-body">
        ...
        @if($stipend)
          ...
          <form novalidate="novalidate" action="{{ '/stipend_request/'.$stipend->id }}" method="post" class="form-horizontal">
                ...
                <div class="col-md-12 col-sm-12">
                  ...
                  <div class="form-group{{ $errors->has('assignment_id') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                      <select id="assignment_id" name="assignment_id" class="form-control">
                        ...
                        <option value="{{ $asg }}" title="{{ $assignment->name }}" selected="selected">
                  ...
                  <div class="form-group{{ $errors->has('site_id') ? ' has-error' : '' }}">
                    <label for="site_ids" class="col-md-4 control-label">
                      Sitio
                      <br>
                      <em style="font-weight: normal">(Seleccione varios sitios con 'ctrl')</em>
                    </label>
                      ...
                      <select id="site_ids" name="site_ids[]" class="form-control" multiple="multiple">
                        ...
                        @foreach($sites as $site)
                          <option value="{{ $site->id }}" title="{{ $site->name }}"
                              {{ ($stipend && $stipend->site_ids && in_array($site->id, $stipend->site_ids)) ||
                                    (old('site_ids') && in_array($site->id, old('site_ids'))) ? 'selected="selected"' : '' }}>
                  ...
                  <div class="form-group{{ $errors->has('date_from') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-3">
                      <input id="date_from" type="date" class="form-control" name="date_from"
                            ...
                            value="{{ $stipend ? $stipend->date_from->format('Y-m-d') : (old('date_from') ?: date('Y-m-d')) }}">
                  ...
                  <div class="form-group{{ $errors->has('date_to') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-3">
                      <input id="date_to" type="date" class="form-control" name="date_to"
                            step="1" min="{{ $assignment->start_date->format('Y-m-d') }}"
                            max="{{ $assignment->end_date->format('Y-m-d') }}"
                            value="{{ $stipend ? $stipend->date_to->format('Y-m-d') : (old('date_to') ?: '') }}">
                  ...
                  <div class="form-group {{ $errors->has('per_day_amount') || $errors->has('hotel_amount') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-2">
                      <input id="per_day_amount" type="number" class="form-control viatico dynamic"
                            ...
                            value="{{ $stipend && $stipend->per_day_amount!=0 ? $stipend->per_day_amount : old('per_day_amount') }}"
                    ...
                    <div class="col-md-2">
                      <input id="hotel_amount" type="number" class="form-control viatico dynamic"
                            ...
                            value="{{ $stipend && $stipend->hotel_amount!=0 ? $stipend->hotel_amount : old('hotel_amount') }}"
                            placeholder="Bs" required>
                  ...
                  <div class="form-group{{ $errors->has('reason') ? ' has-error' : '' }}">
                    ...
                    <div class="col-md-6">
                      <textarea rows="3" class="form-control" id="reason"
                                name="reason">{{ $stipend ? $stipend->reason : old('reason') }}</textarea>
