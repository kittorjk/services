            ...
            foreach($ocs as $oc)
            {
                ...
                $sheet_content->prepend(
                    [   '#'                             => $oc->id,
                        ...
                        'Monto pagado'                  => $oc->payed_amount + 0, // number_format($oc->payed_amount,2),
                        'Pendiente de pago'             => $oc->executed_amount - $oc->payed_amount + 0, // number_format($oc->executed_amount-$oc->payed_amount,2),
