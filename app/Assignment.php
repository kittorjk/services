...
{
  protected $fillable = ['id', 'user_id', 'project_id', 'code', 'literal_code', 'client_code',
    'cost_center', 'name', 'client', 'status', 'resp_id', 'contact_id', 'start_line', 'deadline',
    'quote_from', 'quote_to', 'start_date', 'end_date', 'billing_from', 'billing_to', 'type', 
    'sub_type', 'type_award', 'percentage_completed', 'quote_price', 'executed_price', 'assigned_price',
    'charged_price', 'observations', 'branch_id', 'branch', 'created_at'];
